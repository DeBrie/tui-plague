...
export const evolveSpecialAbility = (state, abilityId) => {
    const ability = specialAbilities.find((a) => a.id === abilityId);
    if (!ability)
        return state;
    // Check if can purchase
    if (ability.timesPurchased >= ability.maxPurchases)
        return state;
    if (state.dnaPoints < ability.cost)
        return state;
    // Mark as purchased
    ...
    switch (ability.effect.type) {
        case "cure_slow":
            plague.cureSlowdown = Math.min(0.9, plague.cureSlowdown + ability.effect.value);
            break;
        case "visibility_reduce":
            plague.visibilityReduction += ability.effect.value;
            break;
        case "infectivity":
            plague.infectivity = Math.min(100, plague.infectivity + ability.effect.value);
            break;
        case "severity":
        ...
        case "cure_reset":
            ...
            break;
        case "all_resistance":
            plague.coldResistance = Math.min(5, plague.coldResistance + ability.effect.value);
            plague.heatResistance = Math.min(5, plague.heatResistance + ability.effect.value);
            plague.drugResistance = Math.min(5, plague.drugResistance + ability.effect.value);
            break;
        ...
        case "airborne":
            ...
            break;
        case "waterborne":
            plague.waterborne = Math.min(10, plague.waterborne + ability.effect.value);
            break;
        case "insectborne":
            plague.insectborne = Math.min(10, plague.insectborne + ability.effect.value);
            break;
        case "border_bypass":
            plague.borderBypass = Math.min(0.5, plague.borderBypass + ability.effect.value);
            break;
        case "airport_bypass":
            plague.airportBypass = Math.min(0.5, plague.airportBypass + ability.effect.value);
            break;
        case "seaport_bypass":
            plague.seaportBypass = Math.min(0.5, plague.seaportBypass + ability.effect.value);
            break;
        case "organ_failure":
            plague.lethality = Math.min(100, plague.lethality + ability.effect.value);
